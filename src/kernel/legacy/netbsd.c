...
int k_open(void) {
#warning "Support for this version of NetBSD is deprecated and may be removed in the future"
	o_log(LOG_CRIT, "Support for this version of NetBSD is deprecated and may be removed in the future");
